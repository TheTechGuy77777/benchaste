...
">
        ...
        <div>
            <a href="/"
                style="text-decoration: none; display: inline-flex; align-items: center; gap: 10px; margin-bottom: 20px;">
                <div
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <a href="https://www.facebook.com/share/1G5iTrCZJs/" target="_blank" rel="noopener noreferrer"
                    ...
                    onmouseover="this.style.background='var(--color-gold)'; this.style.color='white'"
                ...
                <a href="https://www.instagram.com/benchaste_landscape?igsh=MWt1bW13dnc4c3YweA=" target="_blank"
                ...
                <a href="https://tiktok.com/@benchasteconstruction2" target="_blank" rel="noopener noreferrer"
                    style="width: 40px; height: 40px; border-radius: 8px; background: rgba(255,255,255,0.08); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.6); text-decoration: none; transition: var(--transition);"
                    onmouseover="this.style.background='var(--color-gold)'; this.style.color='white'"
                    onmouseout="this.style.background='rgba(255,255,255,0.08)'; this.style.color='rgba(255,255,255,0.6)'">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://wa.me/2348068898563" target="_blank" rel="noopener noreferrer"
                    style="width: 40px; height: 40px; border-radius: 8px; background: rgba(255,255,255,0.08); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.6); text-decoration: none; transition: var(--transition);"
        ...
        <div>
            <h4
                style="font-family: var(--font-heading); font-size: 0.9rem; font-weight: 700; color: white; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 24px;">
                Services</h4>
            <ul style="list-style: none; display: flex; flex-direction: column; gap: 12px;">
                @foreach (['Landscape Design', 'Lawn Care', 'Hardscaping', 'Plant & Tree Nursery', 'Sitout Design', 'Football Pitch'] as $service)
                    <li><a href="#services"
                            style="font-size: 0.9rem; color: rgba(255,255,255,0.55); text-decoration: none; transition: var(--transition);"
                            onmouseover="this.style.color='var(--color-gold)'; this.style.paddingLeft='6px'"
                            onmouseout="this.style.color='rgba(255,255,255,0.55)'; this.style.paddingLeft='0'">{{ $service }}</a>
                    </li>
                @endforeach
            </ul>
        </div>
        ...
        <div>
            <h4
                ...
                Quick Links</h4>
            <ul style="list-style: none; display: flex; flex-direction: column; gap: 12px;">
                @foreach (['About Us' => '#about', 'Portfolio' => '#portfolio', 'Testimonials' => '#testimonials', 'Our Process' => '#process', 'Contact Us' => '#contact'] as $label => $link)
                    <li><a href="{{ $link }}"
                            style="font-size: 0.9rem; color: rgba(255,255,255,0.55); text-decoration: none; transition: var(--transition);"
                            onmouseover="this.style.color='var(--color-gold)'; this.style.paddingLeft='6px'"
                            onmouseout="this.style.color='rgba(255,255,255,0.55)'; this.style.paddingLeft='0'">{{ $label }}</a>
                    </li>
                @endforeach
            </ul>
        </div>
        ...
        <div>
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <a href="benchaste2green@gnail.com"
        ...
        <div
            ...
            <div style="display: flex; gap: 24px; flex-wrap: wrap;">
                <a href="#"
                    ...
                    onmouseout="this.style.color='rgba(255,255,255,0.4)'">Privacy Policy</a>
                <a href="#"
                    style="font-size: 0.85rem; color: rgba(255,255,255,0.4); text-decoration: none; transition: var(--transition);"
                    onmouseover="this.style.color='var(--color-gold)'"
                    onmouseout="this.style.color='rgba(255,255,255,0.4)'">Terms of Service</a>
            </div>
        </div>
    </div>
